...
- **Load Management**: Full load lifecycle, driver/truck assignment, status workflow, expense/profit tracking, and file attachments (PDFs/images for invoices and PODs).
